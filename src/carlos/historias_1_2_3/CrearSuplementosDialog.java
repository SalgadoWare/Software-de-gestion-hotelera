 ...
 * @author carlos
 */
public class CrearSuplementosDialog extends javax.swing.JDialog {
 
    
    /**
     * Creates new form CrearPromocionesDialog
     */
    private CrearSuplementosDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void bAceptarCPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAceptarCPActionPerformed
        ...
        //Comprobamos que no se superpone con otros suplementos
        else if(esFechaUnica && !BD.fechasSuplementosValidoParaTodosLosRangosDeLaBD(fechaIni.toInstant().atZone(ZoneId.systemDefault()).toLocalDate(), fechaIni.toInstant().atZone(ZoneId.systemDefault()).toLocalDate())){
            JOptionPane.showMessageDialog(null,"Esa fecha no se puede introducir.\nYa hay un suplemento que se superpone con esa fecha", "Fecha errónea",JOptionPane.WARNING_MESSAGE);
        }
        else if(esRangoDeFechas && !BD.fechasSuplementosValidoParaTodosLosRangosDeLaBD(fechaIni.toInstant().atZone(ZoneId.systemDefault()).toLocalDate(), fechaFin.toInstant().atZone(ZoneId.systemDefault()).toLocalDate())){
            JOptionPane.showMessageDialog(null,"Ese rango de fechas no se puede introducir.\nYa hay un suplemento que se superpone con esas fechas", "Rango de fechas erróneo",JOptionPane.WARNING_MESSAGE);
        }
            ...
            if(!BD.fechasPromocionesValidoParaTodosLosRangosDeLaBD(Ini, Fin)){
                int opcion_seleccioanda = JOptionPane.showConfirmDialog(null,"Existe una promoción que se superpone en fechas con el suplemento que quieres crear.\n¿Quieres crear el suplemento de todas formas?", "Fecha se superpone con promoción",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
                //Si el usuario elige no, es como si no pulsase el boton aceptar
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrearSuplementosDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CrearSuplementosDialog dialog = new CrearSuplementosDialog(new javax.swing.JFrame(), true);
