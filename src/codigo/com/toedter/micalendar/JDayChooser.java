...
//	}
	 ...
	 * @param jLabel2 
	 */
	public JDayChooser(boolean weekOfYearVisible, JLabel jLabel2) {
		setName("JDayChooser");
		...
		for (int i = 0; i < 7; i++) {
			...
			weeks[i].addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					JCalendar.weekSelected = Integer.parseInt(weeks[j].getText());
					jLabel2.setText(weeks[j].getText());
					JOptionPane.showMessageDialog(new JFrame(), "Has seleccionado la semana " + JCalendar.weekSelected);
				}
			});
