...
import historia2.negocio.SAModalidad;
 ...
 * @author alex
 */
public class GUIAltaModalidad2 extends javax.swing.JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private GUIAltaModalidad gui;
	private Date inicioTarifa;
	private Date finTarifa;
	private String tipoModalidad, inicioTarifa_s, finTarifa_s;
	 ...
	 */
	public GUIAltaModalidad2() {
		initComponents();
	}

	GUIAltaModalidad2(GUIAltaModalidad aThis) {
	...
	private void initComponents() {
		...
		labelDeTipoModalidad = new javax.swing.JLabel();
		jPanel10 = new javax.swing.JPanel();
		jLabel4 = new javax.swing.JLabel();
		jPanel11 = new javax.swing.JPanel();
		jPanel12 = new javax.swing.JPanel();
		labelTipodeHabitacion = new javax.swing.JLabel();
		jPanel14 = new javax.swing.JPanel();
		jPanel3 = new javax.swing.JPanel();
		jPanel15 = new javax.swing.JPanel();
		jLabel3 = new javax.swing.JLabel();
		micampo = new javax.swing.JTextField();
		jButton1 = new javax.swing.JButton();

		setDefaultCloseOperation(javax.swing.WindowConstants.DO_NOTHING_ON_CLOSE);
		setTitle("Pulsa aceptar cuando hayas inroducido la tarifa");
		...
		labelDeTipoModalidad.setText("jLabel3");
		jPanel2.add(labelDeTipoModalidad);
		...
		jLabel4.setText("para una habitacion");
		jPanel2.add(jLabel4);
		...
		labelTipodeHabitacion.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
		jPanel2.add(labelTipodeHabitacion);
		...
		jLabel3.setText("Tendra un suplemento de ");
		jPanel3.add(jLabel3);

		micampo.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				micampoActionPerformed(evt);
			}
		});
		jPanel3.add(micampo);
	...
	private void micampoActionPerformed(java.awt.event.ActionEvent evt) {
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		...
		try {
			precio = Double.parseDouble(micampo.getText());
		} catch (Exception e) {
			valido = false;
		...
		if (valido) {
			try {
				setVisible(false);
				new SAModalidad()
						.alta(new TransferModalidad(inicioTarifa, finTarifa, tipoModalidad, precio, tipoHabitacion));
	...
	private javax.swing.JLabel labelDeTipoModalidad;
	private javax.swing.JLabel labelFechaFin;
	private javax.swing.JLabel labelFechaInicio;
	private javax.swing.JLabel labelTipodeHabitacion;
	private javax.swing.JTextField micampo;
	// End of variables declaration

	void showInfo(Date inicioTarifa, Date finTarifa, String ad, int tipoHabitacion) {
		this.inicioTarifa = inicioTarifa;
		this.finTarifa = finTarifa;
		this.tipoModalidad = ad;
		this.tipoHabitacion = tipoHabitacion;
		inicioTarifa_s = dateFormat.format(inicioTarifa);
		finTarifa_s = dateFormat.format(finTarifa);
		labelFechaInicio.setText(inicioTarifa_s);
		labelFechaFin.setText(finTarifa_s);
		labelDeTipoModalidad.setText(tipoModalidad);
		labelTipodeHabitacion.setText("de " + String.valueOf(tipoHabitacion) + " habitaciones");
		setVisible(true);
	}
}
