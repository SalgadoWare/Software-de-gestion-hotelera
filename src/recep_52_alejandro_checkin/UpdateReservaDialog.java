...
import recep_52_alejandro_checkin.carlos.HabitacionesReservaAnularReserva;
import recep_52_alejandro_checkin.carlos.ReservaHabitacion;

/**
 *
 * @author carlos
 */
public class UpdateReservaDialog extends javax.swing.JDialog {

	/**
	 * Creates new form CrearReservaDialog
	 */
	private UpdateReservaDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
		iniciarComponentesMio();
	}

	public UpdateReservaDialog(List<recep_50_alejandro_checkout.ReservaHabitacion> lista, int idReserva) {
	...
	int idReserva;
	List<recep_50_alejandro_checkout.ReservaHabitacion> lista;
	...
	private void inicializarTablas() {
		...
		for (recep_50_alejandro_checkout.ReservaHabitacion l : lista) {
			String tipos = null;
			switch (l.getTipohabitacion()) {
			case 1:
				tipos = "individual";
				break;
			case 2:
			...
			String ini = sdf.format(l.getFechaEntrada());
			String fin = sdf.format(l.getFechaSalida());

			String[] s = { l.getIdHabitacion(), tipos, ini, fin, l.getModalidad() };
